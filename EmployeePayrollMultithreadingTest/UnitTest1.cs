...
namespace EmployeePayrollMultithreadingTest
{
    ...
    public class UnitTest1
    {
        ...
        public void GivenListOfEmployeesWhenAddedToList_ShouldMatchTheEntriesWithoutThreading()
        {
            ...
            employeeList.Add(new EmpModel(employeeName: "Omprkash", startDate: new System.DateTime(2020, 02, 01), phoneNumber: 7865678765, address: "Mumbai", department: "Sales", gender: "M", basicPay: 60000, deductions: 2000, taxablePay: 58000, tax: 1000, netPay: 57000));
